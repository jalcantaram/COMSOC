  ...
  <div style="width:100%; display: block; padding: 0% 0% 0% 0%">
    <table class="tg2">
      ...
      @php
        $total = 0;
      @endphp       
      @foreach($registroPersonalInternacional['comisionados'] as $key => $item)
        <tr>
      ...
      <tr style="background-color: #EEECEC;">
       <td colspan="10" valign="middle" style="border-right-width:0px; border-bottom-width: 0px; border-top-width: 0px; font-size:15px; text-align:right; padding: 0% 2% 0% 1%;"><strong>Total de Gasto de Comisionados:</strong></td>
       <td colspan="5" valign="middle" style="border-right-width:0px; border-bottom-width: 0px; border-top-width: 0px; font-size:15px; text-align:left; padding: 0% 0% 0% 0%;"><strong>{{ "$".number_format($total, 2) }}</strong></td>
      </tr>
    </table>
  </div>
</div>
