      ...
      <div class="panel panel-default">
        ...
        <div id="collapseOne" class="panel-collapse collapse in">
          <div class="panel-body">
            ...
            <br>
            @if($datos['data']['status'] == 'rechazadoTitular' || $datos['data']['status'] == 'firmaTitular' || $datos['data']['status'] == 'rechazadoDGA' || $datos['data']['status'] == 'Autorizado')
...
<script src="{!! asset('assets/js/pdfjs/shared/compatibility.js') !!}"></script>
@endsection
@section('customjs')
